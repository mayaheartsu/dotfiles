...
yay -S --noconfirm afetch base base-devel bitwarden blueman bluez-tools brillo btop catppuccin-gtk-theme-mocha darkly-bin discord dunst fastfetch file-roller firefox fzf geeqie gimp git gparted grim guvcview helium-browser-bin hyfetch hyprland hyprcursor hypridle hyprlang hyprlock hyprpaper hyprpolkitagent hyprsysteminfo inter-font kitty libnotify light linux-headers localsend ly man-db meld mpv nano nemo nemo-fileroller noto-fonts-cjk noto-fonts-emoji nwg-look obs-studio oh-my-posh-bin pamixer pavucontrol pipewire pipewire-alsa pipewire-audio pipewire-pulse pipewire-jack polkit polkit-kde-agent proton-vpn-gtk-app python-requests qogir-icon-theme qt5ct ranger reflector rofi-wayland rofi-emoji rose-pine-cursor rose-pine-hyprcursor slurp stow swappy swaync syncthing tenacity timeshift tealdeer ttf-cascadia-code-nerd ttf-font-awesome waybar wf-recorder wl-clipboard wget wireplumber wlogout wlr-randr xdg-desktop-portal-hyprland xdg-user-dirs xed yazi zoxide zsh
